...
def test_check_all_contact_fields(app, db):
    ...
    for contact in contacts_list:
        ...
        assert contact.all_emails_from_homepage == merge_email_like_on_homepage(db.get_contact_id(contact.id))
        assert contact.all_phones_from_homepage == merge_phones_like_on_homepage(db.get_contact_id(contact.id))
