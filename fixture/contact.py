...
class ContactHelper:
        ...
        if self.contact_cache is None:
            ...
            for element in wd.find_elements_by_name("entry"):
                ...
                self.contact_cache.append(Contact(id=id, lastname=lastname, firstname=firstname,
                                                  ...
                                                  workphone=all_phones[2], secondaryphone=all_phones[0],))
    ...
    def open_contact_to_edit_by_index(self, index):
        ...
        cell = wd.find_element_by_tag_name("td")[7]
    ...
    def open_contact_view_by_index(self, index):
        ...
        self.app.open_home_page()
        row = wd.find_element_by_name("entry")[index]
        cell = wd.find_element_by_tag_name("td")[6]
        cell.find_element_by_tag_name("a").click()
    ...
    def get_contact_info_from_edit_page(self, index):
        ...
        return Contact(firstname=firstname, lastname=lastname, id=id,
                       homepage=homephone, workphone=workphone,
